...
Continue building interview-ready production support answers.

Focus on:
- Explaining troubleshooting approach clearly
- Connecting tools with investigation steps
- Practicing answers without reading notes
- Improving confidence in production scenarios
...
| 8 | How do you troubleshoot an application outage? (Revision) | ✅ | 🟡 | 7/10 |
| 9 | Application is slow — how do you investigate? (Revision) | ✅ | 🟡 | 7/10 |
| 10 | Load Balancer reports unhealthy targets — what would you check? (Revision) | ✅ | 🟡 | 7/10 |
